...
function DiscordIcon({ className = "w-5 h-5 sm:w-6 sm:h-6" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
  ...
  return (
    <section className="relative w-full min-h-screen bg-black text-white overflow-hidden flex items-start lg:items-center select-none">
      ...
      <div className="relative z-10 w-full max-w-[1480px] mx-auto px-5 sm:px-8 lg:pl-10 lg:pr-8 pt-10 sm:pt-14 pb-[55vh] sm:pb-[50vh] lg:py-16 flex flex-col lg:flex-row items-center lg:items-center justify-between min-h-screen gap-10 lg:gap-6">
        ...
        {/* RIGHT COLUMN: Overlaid Floating TON Network Box (Desktop Only) */}
        <div className="hidden lg:flex flex-col items-end justify-end gap-3.5 self-end lg:mb-16 lg:mr-0 xl:mr-2">
          
          {/* Network (TON) Box */}
          <Magnetic strength={0.2}>
            <div className="w-56 sm:w-64 bg-black/80 backdrop-blur-lg border border-[#486318]/70 hover:border-[#9FD401] rounded-2xl p-4.5 transition-all duration-300 shadow-[0_8px_30px_rgba(0,0,0,0.7)] hover:shadow-[0_0_25px_rgba(159,212,1,0.3)]">
              ...
              <div className="mt-1.5 flex items-center gap-2.5">
                <div className="relative w-7 h-7 sm:w-8 sm:h-8 flex-shrink-0 flex items-center justify-center">
                  <Image
                    src="/ton logo.webp"
                    alt="TON Network Logo"
                    width={32}
                    height={32}
                    className="w-full h-full object-contain"
                  />
                </div>
                <span className="font-morton font-black text-xl sm:text-2xl text-white tracking-wider">
                  TON
                </span>
              </div>
            </div>
